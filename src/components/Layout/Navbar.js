...
export const Navbar = () => {
  ...
  const { modules } = useResumeContext();
  ...
  const collegeNavigation = [
    ...
    // {
    //   name:"Test Patterns",
    //   href: "/dashboard/admin/testpatterns"
    // }
  ];
  ...
  const studentNavigation = [
    ...
    {
      name: "Order",
      href: "/dashboard/student/order"
    },
    {
      name: "Products",
      href: "/dashboard/student/products"
    },
    {
      name: "Documentation",
      href: "/dashboard/student/documentation",
    },
    // {
    //   name: "Resumes",
  ...
  const individualNavigation = [
    ...
    {
      name: "Order",
      href: "/dashboard/individual/order"
    },
    {
      name: "Products",
      href: "/dashboard/individual/products"
    },
    {
      name: "Documentation",
      href: "/dashboard/individual/documentation",
    },
